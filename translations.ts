export const translations = {
    en: {
        ...
        ramadan_mode_off: "Ramadan Mode is Off",
        enable_ramadan_mode: "Enable Ramadan Mode in Settings to access features like Suhoor countdown, Iftar times, and more.",
        go_to_settings: "Go to Settings",
        ramadan_kareem: "Ramadan Kareem",
        time_until_iftar: "Time Until Iftar",
        time_until_suhoor: "Time Until Suhoor",
        hrs: "Hrs",
        min: "Min",
        sec: "Sec",
        suhoor: "Suhoor",
        iftar: "Iftar",
        fasting_progress: "Fasting...",
        eating_allowed: "Eating Allowed",
        seven_day_forecast: "7-Day Forecast",
        today: "Today",
        next_suhoor: "Next Suhoor",
        next_iftar: "Next Iftar",
        divine_guidance: "Divine Guidance",
        blessed_time_for: "It's a blessed time for",
        athkar: "Athkar",
    ...
    ar: {
        ...
        evening: "المساء",
        times: "مرة",
        soul_level: "مستوى الروح",
        grade: "الدرجة",
        kcal: "سعرة",
        no_recent_scan: "لا يوجد مسح حديث",
        tap_to_analyze: "اضغط للتحليل",
        hadith_text: "\"إن من خياركم أحاسنكم أخلاقاً.\"",
        sahih_bukhari: "صحيح البخاري",
        ramadan_mode_off: "وضع رمضان مغلق",
        enable_ramadan_mode: "قم بتفعيل وضع رمضان من الإعدادات للوصول إلى مميزات مثل عداد السحور وأوقات الإفطار.",
        go_to_settings: "الذهاب إلى الإعدادات",
        ramadan_kareem: "رمضان كريم",
        time_until_iftar: "الوقت المتبقي للإفطار",
        time_until_suhoor: "الوقت المتبقي للسحور",
        hrs: "س",
        min: "د",
        sec: "ث",
        suhoor: "السحور",
        iftar: "الإفطار",
        fasting_progress: "صائم...",
        eating_allowed: "يُسمح بالأكل",
        seven_day_forecast: "توقعات 7 أيام",
        today: "اليوم",
        next_suhoor: "السحور القادم",
        next_iftar: "الإفطار القادم",
        divine_guidance: "توجيه إلهي",
        blessed_time_for: "هذا وقت مبارك لـ",
        athkar: "الأذكار",
    ...
    ru: {
        ...
        evening: "Вечер",
        times: "раз",
        soul_level: "Уровень души",
        grade: "Оценка",
        kcal: "ккал",
        no_recent_scan: "Нет недавних сканирований",
        tap_to_analyze: "Нажмите для анализа",
        hadith_text: "\"Лучшие среди вас - те, у кого лучшие манеры и характер.\"",
        sahih_bukhari: "Сахих аль-Бухари",
        ramadan_mode_off: "Режим Рамадан выключен",
        enable_ramadan_mode: "Включите режим Рамадан в настройках, чтобы получить доступ к обратным отсчетам и времени Ифтара.",
        go_to_settings: "Перейти в настройки",
        ramadan_kareem: "Рамадан Карим",
        time_until_iftar: "Время до Ифтара",
        time_until_suhoor: "Время до Сухура",
        hrs: "Ч",
        min: "М",
        sec: "С",
        suhoor: "Сухур",
        iftar: "Ифтар",
        fasting_progress: "Пост...",
        eating_allowed: "Можно есть",
        seven_day_forecast: "Прогноз на 7 дней",
        today: "Сегодня",
        next_suhoor: "Следующий Сухур",
        next_iftar: "Следующий Ифтар",
        divine_guidance: "Божественное руководство",
        blessed_time_for: "Благословенное время для",
        athkar: "Азкар",
