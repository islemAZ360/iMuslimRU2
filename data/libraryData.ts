...
export const libraryData: LibraryCategory[] = [
    ...
    {
        id: 'dreams-visions',
        title: 'الرؤى والأحلام وتعبيرها',
        icon: 'nights_stay',
        topics: [
            {
                id: 'dreams-rules',
                title: 'الأصول الشرعية للرؤى',
                icon: 'auto_stories',
                subTopics: [
                    {
                        id: 'types-of-dreams',
                        title: 'أنواع الرؤى والأحلام',
                        blocks: [
                            { type: 'hadith', content: 'الرؤيا ثلاثة: فرؤيا الصالحة بشرى من الله، ورؤيا تحزين من الشيطان، ورؤيا مما يحدث المرء نفسه.' },
                            { type: 'highlight', content: '1. الرؤيا الصالحة (الرحمانية):' },
                            { type: 'text', content: 'هي من الله تعالى، وتكون واضحة لا لبس فيها، وتُبشر بخير أو تُحذر من شر.' },
                            { type: 'highlight', content: '2. الحلم (من الشيطان):' },
                            { type: 'text', content: 'ما يراه النائم من مكروه لترويعه وتحزينه. قال ﷺ: "فإن رأى ما يكره فليتعوذ بالله من شرها ومن شر الشيطان، وليتفل ثلاثاً، ولا يحدث بها أحداً فإنها لن تضره".' },
                            { type: 'highlight', content: '3. حديث النفس:' },
                            { type: 'text', content: 'وهو ما يفكر فيه الإنسان في يقظته أو يغلب على حاله فيراه في منامه (كالجائع يرى أنه يأكل).' }
                        ]
                    },
                    {
                        id: 'ibn-sirin-rules',
                        title: 'أصول التعبير عند ابن سيرين',
                        blocks: [
                            { type: 'text', content: 'يؤكد العلماء أن كتاب "تفسير الأحلام" المنسوب لابن سيرين لم يؤلفه هو، بل جُمع من أقواله.' },
                            { type: 'highlight', content: 'قواعد التعبير الشرعية:' },
                            { type: 'step', content: 'الاستنباط من القرآن: كتفسير "الحبل" بالعهد (واعتصموا بحبل الله)، وتفسير "الخشب" بالنفاق (كأنهم خشب مسندة).' },
                            { type: 'step', content: 'الاعتبار بحال الرائي: التفسير يختلف جذرياً بحسب صلاح الرائي أو فساده؛ فالأذان للصالح حج، وللسارق تحذير من قطع يده.' },
                            { type: 'step', content: 'التأويل بالأضداد: قد يُعبر البكاء بالفرح، والضحك بالحزن بناءً على القرائن.' },
                            { type: 'text', content: 'تنبيه: الرؤيا ليست حجة شرعية يُبنى عليها حكم أو يُقطع بها في المستقبل.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'funerals-graves',
        title: 'أحكام الجنائز والمقابر',
        icon: 'hdr_strong',
        topics: [
            {
                id: 'funeral-fiqh',
                title: 'تجهيز الميت ودفنه',
                icon: 'group',
                subTopics: [
                    {
                        ...
                        blocks: [
                            { type: 'text', content: 'تجهيز الميت من فروض الكفاية، وإذا قام به البعض سقط الإثم عن الباقين.' },
                            { type: 'highlight', content: 'أحكام التغسيل:' },
                            { type: 'step', content: 'الأولى بغسل الميت وصيه ثم أقاربه. والرجال يغسلون الرجال، والنساء يغسلن النساء (يُستثنى الزوجان).' },
                            { type: 'step', content: 'يُستر الميت وتُغسل عورته من وراء حائل، ثم يُوضأ كوضوء الصلاة، ويُغسل بماء وسدر وتراً.' },
                            { type: 'step', content: 'تُجعل في الغسلة الأخيرة مادة طيبة كالكافور.' },
                            { type: 'highlight', content: 'أحكام التكفين:' },
                            { type: 'step', content: 'يُستحب تكفين الرجل في 3 أثواب بيضاء ليس فيها قميص ولا عمامة. والمرأة في 5 أثواب.' }
                        ]
                    },
                    {
                        id: 'funeral-prayer-burial',
                        title: 'صلاة الجنازة والدفن',
                        blocks: [
                            { type: 'highlight', content: 'صفة صلاة الجنازة (4 تكبيرات بلا ركوع):' },
                            { type: 'step', content: 'التكبيرة الأولى: قراءة الفاتحة.' },
                            { type: 'step', content: 'التكبيرة الثانية: الصلاة الإبراهيمية.' },
                            { type: 'step', content: 'التكبيرة الثالثة: الدعاء الخالص للميت.' },
                            { type: 'step', content: 'التكبيرة الرابعة: الدعاء للمسلمين ثم التسليم.' },
                            { type: 'highlight', content: 'الدفن وزيارة القبور:' },
                            { type: 'text', content: 'يُدفن الميت في لحد (شق في جانب القبر جهة القبلة) ويُوجه وجهه للقبلة.' },
                            { type: 'text', content: 'يحرم البناء على القبور أو تجصيصها أو الصلاة إليها.' },
                            { type: 'text', content: 'تُشرع زيارة القبور للرجال للاتعاظ وتذكر الآخرة والدعاء للموتى.' }
                        ]
                    }
                ]
            }
    ...
    },
    {
        ...
        title: 'الطب النبوي والأمراض العضوية',
        icon: 'medical_services',
        topics: [
            {
                id: 'natural-remedies',
                ...
                subTopics: [
                    {
                        id: 'honey-blackseed',
                        title: 'العسل والحبة السوداء وزمزم',
                        blocks: [
                            { type: 'highlight', content: '1. العسل:' },
                            { type: 'quran', content: 'يَخْرُجُ مِن بُطُونِهَا شَرَابٌ مُّخْتَلِفٌ أَلْوَانُهُ فِيهِ شِفَاءٌ لِّلنَّاسِ' },
                            { type: 'text', content: 'يعالج أمراض البطن والسعال ومضاد حيوي للالتهابات. جاء رجل للنبي ﷺ يشتكي بطن أخيه، فقال: (اسقه عسلاً).' },
                            { type: 'highlight', content: '2. الحبة السوداء (حبة البركة):' },
                            { type: 'hadith', content: 'إن في الحبة السوداء شفاء من كل داء إلا السام (الموت).' },
                            { type: 'highlight', content: '3. ماء زمزم:' },
                            { type: 'hadith', content: 'ماء زمزم لما شرب له.' },
                            { type: 'text', content: 'طعام طعم وشفاء سقم، ويُستحب التضلع منه بنية الشفاء العضوي والروحي.' }
                        ]
                    },
                    {
                        id: 'cupping-hijama',
                        title: 'الحجامة (شفاء الأمة)',
                        blocks: [
                            { type: 'hadith', content: 'الشفاء في ثلاثة: شربة عسل، وشرطة محجم، وكية نار، وأنهى أمتي عن الكي.' },
                            { type: 'highlight', content: 'فوائد الحجامة شرعاً وطبياً:' },
                            { type: 'step', content: 'تنقي الدم من الأخلاط الرديئة والسموم.' },
                            { type: 'step', content: 'تعالج الصداع النصفي وآلام الظهر والمفاصل.' },
                            { type: 'step', content: 'أوقاتها المستحبة: الأيام الفردية (17، 19، 21) من الشهر الهجري للحجامة الوقائية.' },
                            { type: 'text', content: 'الحجامة العلاجية (للمرض الطارئ) تُفعل في أي وقت احتاجها المريض.' }
                        ]
                    }
                ]
            }
        ...
        topics: [
            {
                ...
                title: 'إسهامات المسلمين في العلوم',
                icon: 'science',
                subTopics: [
                    {
                        id: 'medicine-and-math',
                        title: 'الطب والرياضيات والفلك',
                        blocks: [
                            { type: 'text', content: 'شهد العصر الذهبي للإسلام نهضة علمية غير مسبوقة أسست للعلوم الحديثة.' },
                            { type: 'highlight', content: 'الطب والصيدلة:' },
                            { type: 'text', content: 'أسس ابن سينا كتاب "القانون في الطب" الذي ظل المرجع الأساسي لأوروبا لسبعة قرون. واكتشف ابن النفيس الدورة الدموية الصغرى قبل الغرب بمئات السنين. وأسس الزهراوي علم الجراحة الحديثة وابتكر أدوات جراحية لا تزال تستخدم.' },
                            { type: 'highlight', content: 'الرياضيات والجبر:' },
                            { type: 'text', content: 'أسس محمد بن موسى الخوارزمي علم الجبر كعلم مستقل، وابتكر نظام الخوارزميات (Algorithms) الذي تقوم عليه البرمجة والحواسيب اليوم، كما نقل المسلمون الأرقام الهندية وطوروها للنسق الحالي، وأضافوا الصفر.' },
                            { type: 'highlight', content: 'الفلك والفيزياء:' },
                            { type: 'text', content: 'أسس ابن الهيثم علم البصريات الحديث، وصحح نظرية الرؤية (الضوء ينعكس من الأجسام للعين وليس العكس)، ووضع أسس الكاميرا (القمرة).' }
                        ]
                    },
                    {
                        id: 'islamic-institutions',
                        title: 'المؤسسات الحضارية',
                        blocks: [
                            { type: 'highlight', content: 'البيمارستانات (المستشفيات):' },
                            { type: 'text', content: 'لم تكن مجرد دور للعلاج، بل مستشفيات تعليمية، تُقسم للأمراض الباطنية والجراحة والأمراض العقلية، وتصرف الأدوية مجاناً للمرضى.' },
                            { type: 'highlight', content: 'المكتبات والجامعات:' },
                            { type: 'text', content: 'أسس المسلمون أقدم جامعات العالم المستمرة للآن كجامعة القرويين بالمغرب (أسستها فاطمة الفهرية)، وجامع الزيتونة، والأزهر. وكانت "بيت الحكمة" في بغداد أعظم مركز للترجمة والبحث العلمي في العالم.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'contemporary-fatawa',
        title: 'فتاوى معاصرة ونوازل',
        icon: 'gavel',
        topics: [
            {
                id: 'medical-fatawa',
                title: 'نوازل طبية ومالية',
                icon: 'vaccines',
                subTopics: [
                    {
                        id: 'organ-donation-ivf',
                        title: 'نقل الأعضاء وأطفال الأنابيب',
                        blocks: [
                            { type: 'text', content: 'تتطور الشريعة لاستيعاب كل المستجدات الطبية بما يحفظ "الضرورات الخمس".' },
                            { type: 'highlight', content: 'نقل الأعضاء والتبرع بها:' },
                            { type: 'step', content: 'يجوز التبرع بعضو من حي إلى حي (كالكلى) بشرط ألا يضر المتبرع ضرراً بالغاً.' },
                            { type: 'step', content: 'نقل الأعضاء من ميت إلى حي جائز بشرط وصية الميت قبل موته أو موافقة ورثته، وألا يكون العضو من العورات المغلظة، وأن لا يتم ببيع وشراء.' },
                            { type: 'highlight', content: 'أطفال الأنابيب (التلقيح الصناعي):' },
                            { type: 'text', content: 'جائز ومباح شرعاً إذا كان التلقيح بين نطفة الزوج وبويضة الزوجة، وتم الزرع في رحم الزوجة نفسها، ولا يجوز إطلاقاً الاستعانة بطرف ثالث (متبرع أو أم بديلة) لانتفاء حفظ الأنساب.' }
                        ]
                    },
                    {
                        id: 'crypto-finance',
                        title: 'العملات الرقمية والمعاملات المعاصرة',
                        blocks: [
                            { type: 'highlight', content: 'العملات المشفرة (الكريبتو):' },
                            { type: 'text', content: 'اختلف فيها المعاصرون؛ فمنعها البعض لغلبة الغرر والمقامرة والجهالة فيها، وأجازها آخرون إذا توفرت فيها شروط الثمنية واعتُبرت مالاً متقوماً. ويُنصح بتجنب التداول بـ "المارجن" (الرافعة المالية) لاشتماله على الربا.' },
                            { type: 'highlight', content: 'التسويق الشبكي والهرمي:' },
                            { type: 'text', content: 'أكثر المجامع الفقهية على تحريمه، لأنه يتضمن أكل أموال الناس بالباطل، والغرر، وأن السلعة فيه غالباً ليست مقصودة لذاتها بل غطاء لجمع العمولات.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'women-in-islam',
        title: 'المرأة في الإسلام وحقوقها',
        icon: 'woman',
        topics: [
            {
                id: 'women-rights',
                title: 'مكانة المرأة وحقوقها المالية والزوجية',
                icon: 'balance',
                subTopics: [
                    {
                        id: 'dignity-and-rights',
                        title: 'التكريم الإسلامي للمرأة',
                        blocks: [
                            { type: 'hadith', content: 'إنما النساء شقائق الرجال.' },
                            { type: 'quran', content: 'وَلَهُنَّ مِثْلُ الَّذِي عَلَيْهِنَّ بِالْمَعْرُوفِ ۚ وَلِلرِّجَالِ عَلَيْهِنَّ دَرَجَةٌ' },
                            { type: 'text', content: 'قبل الإسلام، كانت المرأة تُورث وتُوأد. فجاء الإسلام وأعطاها ذمة مالية مستقلة كاملة، وحق الميراث، وحق اختيار الزوج، وحق طلب التفريق (الخلع).' },
                            { type: 'highlight', content: 'الذمة المالية المستقلة:' },
                            { type: 'text', content: 'لا يحق للزوج أو الأب أخذ شيء من مال المرأة (ميراثها، راتبها، مهرها) إلا بطيب نفس منها. والنفقة واجبة على الرجل حتى لو كانت المرأة غنية.' }
                        ]
                    },
                    {
                        id: 'misconceptions',
                        title: 'الرد على شبهات حول المرأة',
                        blocks: [
                            { type: 'highlight', content: 'شبهة ناقصات عقل ودين:' },
                            { type: 'text', content: 'نقص الدين: رخصة من الله لها بترك الصلاة والصوم أيام الحيض (وهو تخفيف لا ذم). ونقص العقل: تغليب العاطفة على العقل في مواقف معينة (وهو ميزة لنجاح أمومتها وتربيتها).' },
                            { type: 'highlight', content: 'شبهة الميراث (للذكر مثل حظ الأنثيين):' },
                            { type: 'text', content: 'هذه القاعدة ليست عامة. فهناك حالات ترث فيها المرأة مثل الرجل (كالإخوة لأم)، وحالات ترث فيها أكثر من الرجل، وحالات ترث هي ولا يرث الرجل. التفاوت في الميراث سببه التكليف المالي (النفقة، المهر، الدية) وليس التفضيل الجنسي.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'islamic-politics',
        title: 'السياسة الشرعية ونظام الحكم',
        icon: 'account_balance',
        topics: [
            {
                id: 'governance-principles',
                title: 'مبادئ الحكم في الإسلام',
                icon: 'assured_workload',
                subTopics: [
                    {
                        id: 'shura-and-justice',
                        title: 'الشورى والعدل',
                        blocks: [
                            { type: 'quran', content: 'وَأَمْرُهُمْ شُورَىٰ بَيْنَهُمْ' },
                            { type: 'text', content: 'النظام السياسي الإسلامي لا يقر الاستبداد. الشورى مبدأ ملزم للحاكم في القضايا الكبرى.' },
                            { type: 'highlight', content: 'أسس الحكم الإسلامي:' },
                            { type: 'step', content: 'العدل المطلق: (إن الله يأمركم أن تؤدوا الأمانات إلى أهلها وإذا حكمتم بين الناس أن تحكموا بالعدل). ويشمل العدل مع المسلم ومع غير المسلم.' },
                            { type: 'step', content: 'المسؤولية (المساءلة): (كلكم راع وكلكم مسئول عن رعيته). وقد وقف عمر بن الخطاب يحاسب من قبل رعيته في طول ثوبه.' },
                            { type: 'step', content: 'الحرية: "متى استعبدتم الناس وقد ولدتهم أمهاتهم أحراراً".' }
                        ]
                    },
                    {
                        id: 'non-muslims-rights',
                        title: 'حقوق غير المسلمين (أهل الذمة)',
                        blocks: [
                            { type: 'hadith', content: 'من ظلم معاهداً أو انتقصه أو كلفه فوق طاقته أو أخذ منه شيئاً بغير طيب نفس، فأنا حجيجه يوم القيامة.' },
                            { type: 'text', content: 'لهم ما للمسلمين وعليهم ما على المسلمين في الحقوق المدنية. تكفل الدولة حمايتهم، ودور عبادتهم، وتتركهم وما يدينون في أحوالهم الشخصية.' }
                        ]
                    }
                ]
            }
        ...
        topics: [
            {
                ...
                subTopics: [
                    {
                        id: 'kibr-hasad-riya',
                        title: 'الكبر، الحسد، والرياء',
                        blocks: [
                            { type: 'quran', content: 'يَوْمَ لَا يَنفَعُ مَالٌ وَلَا بَنُونَ * إِلَّا مَنْ أَتَى اللَّهَ بِقَلْبٍ سَلِيمٍ' },
                            { type: 'highlight', content: '1. الكبر:' },
                            { type: 'hadith', content: 'لا يدخل الجنة من كان في قلبه مثقال ذرة من كبر. الكبر بطر الحق (رفضه) وغمط الناس (احتقارهم).' },
                            { type: 'highlight', content: '2. الحسد:' },
                            { type: 'text', content: 'تمني زوال النعمة عن الغير. وهو يأكل الحسنات كما تأكل النار الحطب. وعلاجه: الدعاء بالبركة للمحسود (ما شاء الله لا قوة إلا بالله) والإيمان التام بقسمة الله ورزقه.' },
                            { type: 'highlight', content: '3. الرياء:' },
                            { type: 'text', content: 'الشرك الأصغر. وهو أن يقوم الرجل يصلي فيزين صلاته لما يرى من نظر رجل. وعلاجه: إخفاء العمل الصالح، وتذكر أن ثناء الناس لا يدخل الجنة.' }
                        ]
                    },
                    {
                        id: 'ihsan-tawakkul',
                        title: 'الإحسان والتوكل والمراقبة',
                        blocks: [
                            { type: 'highlight', content: 'الإحسان (أعلى مراتب الدين):' },
                            { type: 'hadith', content: 'أن تعبد الله كأنك تراه، فإن لم تكن تراه فإنه يراك.' },
                            { type: 'highlight', content: 'التوكل على الله:' },
                            { type: 'text', content: 'اعتماد القلب على الله مع الأخذ بالأسباب. (لو أنكم تتوكلون على الله حق توكله لرزقكم كما يرزق الطير، تغدو خماصاً وتروح بطاناً).' },
                            { type: 'highlight', content: 'المحاسبة:' },
                            { type: 'text', content: 'قال عمر: "حاسبوا أنفسكم قبل أن تحاسبوا، وزنوا أعمالكم قبل أن توزن عليكم".' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'companions-stories',
        title: 'سير الصحابة والخلفاء الراشدين',
        icon: 'groups',
        topics: [
            {
                id: 'four-caliphs',
                ...
                subTopics: [
                    {
                        ...
                        blocks: [
                            { type: 'text', content: 'هو عبد الله بن أبي قحافة، أول من أسلم من الرجال الأحرار، ورفيق النبي ﷺ في الهجرة وثاني اثنين في الغار.' },
                            { type: 'quran', content: 'إِذْ يَقُولُ لِصَاحِبِهِ لَا تَحْزَنْ إِنَّ اللَّهَ مَعَنَا' },
                            { type: 'highlight', content: 'أعظم مواقفه:' },
                            { type: 'step', content: 'أنفق جميع ماله في سبيل الله. سأله النبي ﷺ: "ما أبقيت لأهلك؟" قال: "أبقيت لهم الله ورسوله".' },
                            { type: 'step', content: 'ثبّت الأمة بعد وفاة النبي ﷺ بخطبته الخالدة: "من كان يعبد محمداً فإن محمداً قد مات، ومن كان يعبد الله فإن الله حي لا يموت".' },
                            { type: 'step', content: 'قاتل المرتدين ومانعي الزكاة بحزم: "والله لو منعوني عقالاً كانوا يؤدونه إلى رسول الله لقاتلتهم عليه".' },
                            { type: 'step', content: 'أمر بجمع القرآن الكريم بعد استشهاد كثير من الحفاظ في معركة اليمامة.' }
                        ]
                    },
                    {
                        id: 'umar-khattab',
                        title: 'عمر بن الخطاب (الفاروق) رضي الله عنه',
                        blocks: [
                            { type: 'text', content: 'الملقب بالفاروق لأن الله فرّق به بين الحق والباطل. أعزّ الله بإسلامه الإسلام.' },
                            { type: 'hadith', content: 'لو كان نبي بعدي لكان عمر بن الخطاب.' },
                            { type: 'highlight', content: 'إنجازاته العظيمة:' },
                            { type: 'step', content: 'فتح الشام ومصر والعراق وفارس. ودخلت الأمة في عصرها الذهبي.' },
                            { type: 'step', content: 'وضع التاريخ الهجري، وأسس الدواوين (نظام تسجيل الجيش والرواتب).' },
                            { type: 'step', content: 'كان يتجول ليلاً ليتفقد أحوال الرعية بنفسه، ومن أشهر قصصه: حمل الدقيق على ظهره لامرأة فقيرة.' },
                            { type: 'step', content: 'عدله الأسطوري: قال لعمرو بن العاص عندما ضرب ابنه قبطياً: "متى استعبدتم الناس وقد ولدتهم أمهاتهم أحراراً؟"' }
                        ]
                    },
                    {
                        id: 'uthman-affan',
                        title: 'عثمان بن عفان (ذو النورين) رضي الله عنه',
                        blocks: [
                            { type: 'text', content: 'الملقب بذي النورين لأنه تزوج بنتين من بنات النبي ﷺ: رقية ثم أم كلثوم.' },
                            { type: 'hadith', content: 'ألا أستحي من رجل تستحي منه الملائكة.' },
                            { type: 'highlight', content: 'إنجازاته وكرمه:' },
                            { type: 'step', content: 'جهّز جيش العسرة كاملاً من ماله الخاص (900 بعير و100 فرس ومؤونتهم).' },
                            { type: 'step', content: 'اشترى بئر رومة وجعلها وقفاً مجانياً للمسلمين.' },
                            { type: 'step', content: 'جمع القرآن في مصحف واحد موحد ووزعه على الأمصار (المصحف العثماني الذي بين أيدينا اليوم).' }
                        ]
                    },
                    {
                        id: 'ali-talib',
                        ...
                        blocks: [
                            { type: 'text', content: 'ابن عم النبي ﷺ وصهره، زوج فاطمة الزهراء، من السابقين للإسلام (أسلم صبياً).' },
                            { type: 'hadith', content: 'أنت مني بمنزلة هارون من موسى، إلا أنه لا نبي بعدي.' },
                            { type: 'highlight', content: 'صفاته ومواقفه:' },
                            { type: 'step', content: 'نام في فراش النبي ﷺ ليلة الهجرة فداءً له، وكفار قريش محيطون بالبيت يريدون قتله.' },
                            { type: 'step', content: 'فارس الإسلام الأول: لم يُهزم قط في مبارزة، وحمل لواء المسلمين في خيبر بعد أن عجز غيره.' },
                            { type: 'step', content: '"باب مدينة العلم": كان أعلم الصحابة بالقضاء وأفقههم في كثير من المسائل.' }
                        ]
                    }
                ]
            },
            {
                ...
                subTopics: [
                    {
                        id: 'khalid-bilal-salman',
                        title: 'خالد بن الوليد وبلال وسلمان',
                        blocks: [
                            { type: 'highlight', content: 'خالد بن الوليد (سيف الله المسلول):' },
                            { type: 'text', content: 'قائد عسكري عبقري لم يُهزم في حياته قط. انتصر في مئة معركة. قاد معارك مؤتة واليرموك. قال على فراش الموت: "ما في جسدي موضع شبر إلا وفيه ضربة سيف أو طعنة رمح... وها أنا أموت على فراشي كما يموت البعير، فلا نامت أعين الجبناء".' },
                            { type: 'highlight', content: 'بلال بن رباح (مؤذن الرسول):' },
                            { type: 'text', content: 'عبد حبشي عُذب أشد العذاب في سبيل الله. وُضع تحت الصخرة العظيمة في حر مكة وهو يردد: "أحدٌ أحد". اشتراه أبو بكر وأعتقه. أول مؤذن في الإسلام.' },
                            { type: 'highlight', content: 'سلمان الفارسي (الباحث عن الحق):' },
                            { type: 'text', content: 'رحل من فارس عبر بلاد الشام بحثاً عن الدين الحق. خدم رهباناً مسيحيين أخبره آخرهم بقرب ظهور نبي بالحجاز. فسافر وأُسر وبيع عبداً بالمدينة حتى لقي النبي ﷺ فأسلم. هو صاحب فكرة حفر الخندق في غزوة الأحزاب.' }
                        ]
                    }
                ]
            }
        ...
        topics: [
            {
                ...
                title: 'الأديان الإبراهيمية الثلاثة',
                icon: 'menu_book',
                subTopics: [
                    {
                        id: 'concept-of-god',
                        title: 'مفهوم الإله والتوحيد',
                        blocks: [
                            { type: 'highlight', content: 'الإسلام:' },
                            { type: 'text', content: 'توحيد مطلق. الله واحد أحد ليس كمثله شيء، لا شريك له ولا ولد ولا صاحبة. لم يلد ولم يولد.' },
                            { type: 'highlight', content: 'المسيحية:' },
                            { type: 'text', content: 'عقيدة التثليث (الآب، الابن، الروح القدس). يُنظر للمسيح عند أغلب الطوائف على أنه ابن الله أو تجسيد لله. وهذا المفهوم لم يظهر إلا بعد مجمع نيقية (325م).' },
                            { type: 'highlight', content: 'اليهودية:' },
                            { type: 'text', content: 'توحيد نسبي. يؤمنون بإله واحد لكنهم يعتبرونه "إلهاً خاصاً" ببني إسرائيل ويصفونه بصفات بشرية في التوراة المحرفة (كالندم والتعب والمصارعة).' }
                        ]
                    },
                    {
                        id: 'salvation-afterlife',
                        title: 'الخلاص واليوم الآخر',
                        blocks: [
                            { type: 'highlight', content: 'الإسلام (المسؤولية الفردية):' },
                            { type: 'quran', content: 'وَلَا تَزِرُ وَازِرَةٌ وِزْرَ أُخْرَىٰ' },
                            { type: 'text', content: 'كل نفس بما كسبت رهينة. لا خطيئة أصلية متوارثة. آدم تاب فتاب الله عليه. النجاة بالإيمان والعمل الصالح.' },
                            { type: 'highlight', content: 'المسيحية (الفداء بالصلب):' },
                            { type: 'text', content: 'يؤمنون بأن المسيح صُلب فداءً للبشرية من "الخطيئة الأصلية" التي ارتكبها آدم. والإسلام ينفي صلب المسيح: "وما قتلوه وما صلبوه ولكن شُبه لهم".' },
                            { type: 'highlight', content: 'اليهودية (غموض اليوم الآخر):' },
                            { type: 'text', content: 'تركز على الشريعة والعهد مع الله في الدنيا، وتختلف الرؤى اليهودية حول تفاصيل البعث والحساب والجنة والنار.' }
                        ]
                    }
                ]
            }
    ...
    },
    {
        ...
        topics: [
            {
                id: 'eating-drinking',
                title: 'آداب الأكل والشرب واللباس',
                icon: 'local_dining',
                subTopics: [
                    {
                        id: 'food-manners',
                        title: 'آداب الطعام والشراب النبوية',
                        blocks: [
                            { type: 'hadith', content: 'يا غلام، سمِّ الله، وكل بيمينك، وكل مما يليك.' },
                            { type: 'highlight', content: 'قبل الأكل:' },
                            { type: 'step', content: 'غسل اليدين والتسمية (بسم الله). ومن نسي يقول: بسم الله أوله وآخره.' },
                            { type: 'highlight', content: 'أثناء الأكل:' },
                            { type: 'step', content: 'الأكل باليمنى ومما يليك.' },
                            { type: 'step', content: 'عدم ذم الطعام: ما عاب النبي ﷺ طعاماً قط، إن اشتهاه أكله وإلا تركه.' },
                            { type: 'step', content: 'تجنب النفخ في الطعام أو الشراب الساخن.' },
                            { type: 'step', content: 'الشرب على 3 دفعات وليس دفعة واحدة، والتنفس خارج الإناء.' },
                            { type: 'highlight', content: 'بعد الأكل:' },
                            { type: 'step', content: 'الحمد لله. ومن الأدعية: "الحمد لله الذي أطعمني هذا ورزقنيه من غير حول مني ولا قوة".' }
                        ]
                    },
                    {
                        id: 'clothing-manners',
                        title: 'آداب اللباس والزينة',
                        blocks: [
                            { type: 'text', content: 'اللباس في الإسلام يحقق غايتين: ستر العورة، والتجمل في حدود الشرع.' },
                            { type: 'step', content: 'البدء باليمين عند اللبس وباليسار عند الخلع.' },
                            { type: 'step', content: 'تحريم الحرير والذهب على الرجال، وإباحتهما للنساء.' },
                            { type: 'step', content: 'تحريم لباس الشهرة (ما يلبسه ليُشتهر بين الناس تكبراً).' },
                            { type: 'hadith', content: 'من لبس ثوب شهرة ألبسه الله ثوب مذلة يوم القيامة.' },
                            { type: 'step', content: 'دعاء لبس الثوب الجديد: "اللهم لك الحمد أنت كسوتنيه، أسألك خيره وخير ما صنع له، وأعوذ بك من شره وشر ما صنع له".' }
                        ]
                    }
                ]
            },
            {
                id: 'social-etiquette',
                title: 'آداب السلام والاستئذان والمجلس',
                icon: 'handshake',
                subTopics: [
                    {
                        id: 'salam-rules',
                        title: 'آداب السلام والمصافحة',
                        blocks: [
                            { type: 'hadith', content: 'لا تدخلوا الجنة حتى تؤمنوا، ولا تؤمنوا حتى تحابوا، أولا أدلكم على شيء إذا فعلتموه تحاببتم؟ أفشوا السلام بينكم.' },
                            { type: 'highlight', content: 'قواعد إلقاء السلام:' },
                            { type: 'step', content: 'الراكب يسلم على الماشي، والماشي على القاعد.' },
                            { type: 'step', content: 'القليل يسلم على الكثير، والصغير على الكبير.' },
                            { type: 'step', content: 'رد السلام واجب (وعليكم السلام ورحمة الله وبركاته).' }
                        ]
                    },
                    {
                        id: 'permission-rules',
                        title: 'آداب الاستئذان وزيارة البيوت',
                        blocks: [
                            { type: 'quran', content: 'يَا أَيُّهَا الَّذِينَ آمَنُوا لَا تَدْخُلُوا بُيُوتًا غَيْرَ بُيُوتِكُمْ حَتَّىٰ تَسْتَأْنِسُوا وَتُسَلِّمُوا عَلَىٰ أَهْلِهَا' },
                            { type: 'step', content: 'الاستئذان ثلاث مرات، فإن لم يُؤذن لك فارجع.' },
                            { type: 'step', content: 'عدم الوقوف أمام الباب مباشرة حتى لا تقع عينك على ما في الداخل.' },
                            { type: 'step', content: 'ذكر اسمك عند السؤال (لا تقل "أنا" بل قل اسمك).' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'fiqh-marriage',
        title: 'فقه النكاح والأسرة المسلمة',
        icon: 'favorite',
        topics: [
            {
                id: 'marriage-rules',
                ...
                subTopics: [
                    {
                        id: 'marriage-conditions',
                        title: 'أركان النكاح وشروطه',
                        blocks: [
                            { type: 'hadith', content: 'يا معشر الشباب، من استطاع منكم الباءة فليتزوج، فإنه أغض للبصر وأحصن للفرج.' },
                            { type: 'highlight', content: 'أركان النكاح:' },
                            { type: 'step', content: 'الزوجان (الخاليان من الموانع الشرعية كالمحرمية).' },
                            { type: 'step', content: 'الإيجاب والقبول (الصيغة).' },
                            { type: 'highlight', content: 'شروط صحة النكاح:' },
                            { type: 'step', content: 'الولي: لا نكاح إلا بولي (الأب أو من ينوب عنه).' },
                            { type: 'step', content: 'الشاهدان العدلان.' },
                            { type: 'step', content: 'المهر: حق واجب للمرأة ولو خاتماً من حديد.' },
                            { type: 'step', content: 'رضا الزوجة: لا يجوز إجبار المرأة البالغة العاقلة على الزواج.' }
                        ]
                    },
                    {
                        id: 'divorce-rules',
                        title: 'أحكام الطلاق والخلع والعدة',
                        blocks: [
                            { type: 'hadith', content: 'أبغض الحلال إلى الله الطلاق.' },
                            { type: 'highlight', content: 'الطلاق السني (الصحيح):' },
                            { type: 'text', content: 'أن يطلقها طلقة واحدة في طهر لم يجامعها فيه، ثم يدعها حتى تنقضي عدتها (3 حيضات). فإن أراد إرجاعها راجعها قبل انقضاء العدة.' },
                            { type: 'highlight', content: 'الخلع (حق المرأة):' },
                            { type: 'text', content: 'إذا كرهت المرأة زوجها ولم تستطع العيش معه، فلها أن تفتدي نفسها بإرجاع المهر أو بعضه. ودليله حديث امرأة ثابت بن قيس التي قالت للنبي ﷺ: "ما أعتب عليه في خلق ولا دين ولكني أكره الكفر في الإسلام".' },
                            { type: 'highlight', content: 'العدة:' },
                            { type: 'step', content: 'المطلقة: 3 حيضات (أو 3 أشهر إن كانت لا تحيض).' },
                            { type: 'step', content: 'المتوفى عنها زوجها: 4 أشهر و10 أيام.' },
                            { type: 'step', content: 'الحامل: حتى تضع حملها.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'islamic-history',
        title: 'التاريخ الإسلامي الكبير',
        icon: 'history_edu',
        topics: [
            {
                id: 'early-islam',
                title: 'العصر النبوي والراشدي',
                icon: 'brightness_5',
                subTopics: [
                    {
                        id: 'mecca-period',
                        title: 'العهد المكي (13 سنة)',
                        blocks: [
                            { type: 'text', content: 'بدأت الدعوة سرية 3 سنوات ثم جهرية 10 سنوات. تعرض المسلمون الأوائل لأشد أنواع الاضطهاد.' },
                            { type: 'highlight', content: 'المراحل الكبرى:' },
                            { type: 'step', content: 'الدعوة السرية: إسلام خديجة وأبي بكر وعلي وزيد وبلال.' },
                            { type: 'step', content: 'الجهر بالدعوة: وما تبعه من أذى قريش (تعذيب بلال وآل ياسر).' },
                            { type: 'step', content: 'الهجرة الأولى إلى الحبشة: لجأ المسلمون الأوائل إلى النجاشي ملك الحبشة العادل.' },
                            { type: 'step', content: 'حصار شعب أبي طالب: 3 سنوات من الحصار الاقتصادي والاجتماعي الخانق.' },
                            { type: 'step', content: 'عام الحزن: وفاة أبي طالب (العم الحامي) وخديجة (الزوجة الحنون) في عام واحد.' },
                            { type: 'step', content: 'الإسراء والمعراج: تكريم إلهي بعد سنوات الابتلاء.' },
                            { type: 'step', content: 'بيعة العقبة الأولى والثانية: الأنصار يدعون النبي ﷺ للمدينة.' }
                        ]
                    },
                    {
                        id: 'medina-period',
                        title: 'العهد المدني (10 سنوات)',
                        blocks: [
                            { type: 'text', content: 'بناء الدولة الإسلامية الأولى. المؤاخاة بين المهاجرين والأنصار. وثيقة المدينة (أول دستور مدني في التاريخ).' },
                            { type: 'highlight', content: 'أعظم الغزوات:' },
                            { type: 'step', content: 'بدر الكبرى (2هـ): 313 مسلماً يهزمون 1000 مشرك. يوم الفرقان.' },
                            { type: 'step', content: 'أحد (3هـ): درس في أهمية طاعة القائد. استشهد 70 صحابياً منهم حمزة.' },
                            { type: 'step', content: 'الخندق (5هـ): حفر الخندق بفكرة سلمان الفارسي. حاصر 10000 مشرك المدينة.' },
                            { type: 'step', content: 'صلح الحديبية (6هـ): فتح مبين بدون قتال، أدى لدخول الناس في الإسلام أفواجاً.' },
                            { type: 'step', content: 'فتح مكة (8هـ): دخل النبي ﷺ مكة بـ 10000 مقاتل دون إراقة دم، وعفا عن أهلها: "اذهبوا فأنتم الطلقاء".' },
                            { type: 'step', content: 'حجة الوداع (10هـ): آخر خطبة للنبي ﷺ أمام 100000 صحابي: "كل المسلم على المسلم حرام: دمه وماله وعرضه".' }
                        ]
                    }
                ]
            },
            {
                id: 'umayyad-abbasid',
                title: 'الدولة الأموية والعباسية',
                icon: 'castle',
                subTopics: [
                    {
                        id: 'umayyad-state',
                        title: 'الدولة الأموية (41-132هـ)',
                        blocks: [
                            { type: 'text', content: 'أسسها معاوية بن أبي سفيان. امتدت من الصين شرقاً إلى الأندلس غرباً. أكبر دولة إسلامية في المساحة.' },
                            { type: 'highlight', content: 'أبرز الخلفاء:' },
                            { type: 'step', content: 'عمر بن عبد العزيز: الخليفة الخامس الراشد. أعاد العدل وردّ المظالم حتى قيل إن الذئب كان يرعى مع الغنم في عهده.' },
                            { type: 'step', content: 'الوليد بن عبد الملك: بنى الجامع الأموي بدمشق، ووسع المسجد النبوي، وعربّ الدواوين.' },
                            { type: 'highlight', content: 'الفتوحات:' },
                            { type: 'step', content: 'فتح طارق بن زياد الأندلس (711م) وأحرق سفنه وراءه.' },
                            { type: 'step', content: 'فتح قتيبة بن مسلم بلاد ما وراء النهر (سمرقند وبخارى).' }
                        ]
                    },
                    {
                        id: 'abbasid-state',
                        title: 'الدولة العباسية (132-656هـ)',
                        blocks: [
                            { type: 'text', content: 'عاصمتها بغداد التي أصبحت أعظم مدن العالم. شهدت العصر الذهبي للعلوم والترجمة.' },
                            { type: 'highlight', content: 'إنجازاتها الحضارية:' },
                            { type: 'step', content: 'بيت الحكمة: أكبر مركز للترجمة في التاريخ، ترجم علوم اليونان والفرس والهند للعربية.' },
                            { type: 'step', content: 'هارون الرشيد: عصره أزهى العصور. تبادل الهدايا مع شارلمان ملك أوروبا.' },
                            { type: 'step', content: 'المأمون: أسس بيت الحكمة ودعم العلماء مادياً وأعطى وزن الكتاب المترجم ذهباً.' },
                            { type: 'text', content: 'انتهت بسقوط بغداد على يد المغول (هولاكو) عام 656هـ في أسوأ كارثة حضارية عرفها العالم الإسلامي.' }
                        ]
                    }
                ]
            }
    ...
    {
        id: 'quran-sciences-detailed',
        title: 'علوم القرآن المتقدمة',
        icon: 'auto_stories',
        topics: [
            {
                id: 'quran-compilation',
                title: 'جمع القرآن وتدوينه',
                icon: 'edit_note',
                subTopics: [
                    {
                        id: 'preservation-history',
                        title: 'تاريخ حفظ القرآن الكريم',
                        blocks: [
                            { type: 'quran', content: 'إِنَّا نَحْنُ نَزَّلْنَا الذِّكْرَ وَإِنَّا لَهُ لَحَافِظُونَ' },
                            { type: 'highlight', content: 'مراحل الجمع الثلاث:' },
                            { type: 'step', content: 'في عهد النبي ﷺ: حُفظ في الصدور وكُتب على الرقاع والعظام والجلود بأمر النبي ﷺ. كان جبريل يراجعه مع النبي كل رمضان.' },
                            { type: 'step', content: 'في عهد أبي بكر: بعد استشهاد 70 حافظاً في اليمامة، أمر زيد بن ثابت بجمعه بين دفتين.' },
                            { type: 'step', content: 'في عهد عثمان: وحّد المصحف على لغة قريش ووزعه على الأمصار لمنع الاختلاف في القراءة.' },
                            { type: 'text', content: 'القرآن هو الكتاب الوحيد في التاريخ الذي نُقل بالتواتر: أي رواه جمع عن جمع يستحيل تواطؤهم على الكذب، في كل طبقة، من لدن النبي ﷺ إلى يومنا هذا.' }
                        ]
                    }
                ]
            },
                ...
                subTopics: [
                    {
                        ...
                        blocks: [
                            { type: 'highlight', content: 'التفسير بالمأثور:' },
                            { type: 'text', content: 'تفسير القرآن بالقرآن، ثم بالسنة، ثم بأقوال الصحابة، ثم بأقوال التابعين. وهو أسلم المناهج وأوثقها. من أشهر كتبه: تفسير ابن كثير، وتفسير الطبري.' },
                            { type: 'highlight', content: 'التفسير بالرأي (الدراية):' },
                            { type: 'text', content: 'الاجتهاد في فهم الآيات بناءً على اللغة العربية وأصول الفقه والعقيدة الصحيحة. يُشترط أن يكون المفسر عالماً متمكناً. من أشهر كتبه: تفسير الكشاف للزمخشري.' },
                            { type: 'highlight', content: 'التفسير الموضوعي:' },
                            { type: 'text', content: 'جمع الآيات المتعلقة بموضوع واحد (كالصبر أو التقوى أو المال) من سور مختلفة ودراستها معاً لاستخلاص الحكم الشامل.' }
                        ]
                    }
                ]
            }
